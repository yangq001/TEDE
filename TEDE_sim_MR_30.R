...
#Simulations in the MR context (independent SNPs, p=30)
...
nam=paste("TEDE_MR_sc",scenario,"_p",p,"_rho",rho,"_beta",size_XY,"_nx",n1,"_ny",n2,".csv",sep="")
